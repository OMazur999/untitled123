...
for (let i = 0; i < 10; i++) {
    document.write(`<div>OWU Super School</div>`)
}

// - За допомогою циклу for і document.write() вивести 10 блоків div c довільним текстом і індексом всередині
for (let i = 0; i < 10; i++) {
    document.write(`<div>${i}: Java Hard Lerning</div>`);
}

// - За допомогою циклу while вивести в документ 20 блоків h1 c довільним текстом всередині.
let i = 0;
while (i < 20) {
    document.write(`<div><h1>${i+1})While1-20</h1></div>`)
    i++;
}
...
let a = 0;
while (a < 20) {
    document.write(`<h1> ${a}_Index0-19</h1>`)
    a++;
}
