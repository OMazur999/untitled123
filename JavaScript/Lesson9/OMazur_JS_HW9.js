...
for (let i = 0; i < coursesAndDurationArray.length; i++) {
    ...
    titleElement.innerText = `Title: ${course.title}`;
    monthDurationElement.innerText = `Month Duration: ${course.monthDuration}`;
    block1.classList.add('omega')

    block1.appendChild(titleElement);
    block1.appendChild(monthDurationElement);
...
for (let i = 0; i < coursesAndDurationArray1.length; i++) {
    ...
    titleHeading.textContent = coursesAndDurationArray1[i].title;

    let monthdurationDescription = document.createElement('p');
    monthdurationDescription.className = 'description';
    monthdurationDescription.textContent = `Month Duration: ${coursesAndDurationArray1[i].monthDuration}`;

    itemDiv.appendChild(titleHeading);
    itemDiv.appendChild(monthdurationDescription);
...
for (let i = 0; i < coursesArray.length; i++) {
    ...
    parentElement.appendChild(courseBlock);
}